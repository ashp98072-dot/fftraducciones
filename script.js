const translations = {
  es: {
    ...
    "nav.cta": "Cotizar",
    "hero.eyebrow": "Guatemala · El Salvador · Costa Rica · Panamá",
    "hero.title": "Traducción e Interpretación Profesional Inglés ↔ Español",
    "hero.subtitle":
      "Rompemos las barreras del idioma. Soluciones lingüísticas precisas y confiables para empresas e individuos en Centroamérica.",
    "hero.cta": "Solicitar Cotización Gratuita",
    ...
    "home.aboutBody": "Equipo de traductores e intérpretes al servicio de Centroamérica.",
    ...
    "services.s4.body": "Revisión exhaustiva para garantizar la perfección de tus textos.",
    "quote.label": "Cotización",
    "quote.title": "¿Tienes un proyecto en mente?",
    "quote.body": "Solicita tu cotización. Te respondemos con una propuesta clara y sin compromiso.",
    "quote.p1": "Respuesta ágil por correo o WhatsApp",
    "quote.p2": "Cobertura en 4 países de Centroamérica",
    "quote.p3": "Inglés ↔ Español",
    "form.name": "Nombre completo",
    "form.email": "Correo electrónico",
    "form.phone": "Teléfono / WhatsApp",
    "form.country": "País",
    "form.country.placeholder": "Selecciona…",
    "form.country.other": "Otro",
    "form.service": "Tipo de servicio",
    "form.service.placeholder": "Selecciona…",
    ...
    "footer.tagline": "Soluciones lingüísticas precisas para empresas e individuos en Centroamérica.",
    "footer.chipLang": "Inglés ↔ Español",
    "footer.chipQuote": "Cotización gratuita",
    "footer.servicesTitle": "Servicios",
    "footer.navTitle": "Navegación",
    "footer.contactTitle": "Contacto",
    "footer.coverageLabel": "Países",
    "footer.countries": "Guatemala, El Salvador, Costa Rica y Panamá",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "nav.cta": "Quote",
    "hero.eyebrow": "Guatemala · El Salvador · Costa Rica · Panama",
    "hero.title": "Professional English ↔ Spanish Translation & Interpretation",
    "hero.subtitle":
      "Breaking language barriers. Accurate and reliable linguistic solutions for businesses and individuals across Central America.",
    ...
    "home.aboutBody": "A team of translators and interpreters serving Central America.",
    ...
    "about.body":
      "At F&F Traducciones, we specialize in connecting businesses and people through language. Our team of skilled translators and interpreters guarantees technical, cultural, and legal accuracy for every project. Serving clients across Guatemala, El Salvador, Costa Rica, Panama, and beyond.",
    ...
    "quote.p2": "Coverage across 4 Central American countries",
    ...
    "footer.tagline": "Accurate linguistic solutions for businesses and individuals across Central America.",
    "footer.chipLang": "English ↔ Spanish",
    "footer.chipQuote": "Free quote",
    "footer.servicesTitle": "Services",
    "footer.navTitle": "Navigation",
    "footer.contactTitle": "Contact",
    "footer.coverageLabel": "Countries",
    "footer.countries": "Guatemala, El Salvador, Costa Rica, and Panama",
