const translations = {
  es: {
    ...
    "about.body":
      "En F&F Traducciones (también conocida como FyF Traducciones), conectamos negocios y personas a través del lenguaje. Nuestro equipo de traductores e intérpretes garantiza precisión técnica, cultural y legal en cada proyecto para clientes en toda Centroamérica. Si busca un traductor en Guatemala o en cualquier otro país de la región, podemos ayudarle con traducción de documentos, interpretación para eventos y localización de contenidos.",
  ...
  en: {
    ...
    "about.body":
      "At F&F Traducciones (also known as FyF Traducciones), we connect businesses and people through language. Our team of translators and interpreters guarantees technical, cultural, and legal accuracy on every project for clients across Central America. Looking for a translator in Guatemala or anywhere else in the region? We can help with document translation, event interpretation, and content localization.",
...
// Highlight the matching nav link as each section scrolls into view.
